...
develop efficient parallel programs. In fact, to achieve **high performance** and scalability, the
implementation of core algorithms often takes advantage of the underlying physical architecture
